...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/MikkelFilip/dotfiles/master/bin/dotfiles)"
```

If you want to run only a specific role, you can specify the following bash command:
```bash
curl -fsSL https://raw.githubusercontent.com/MikkelFilip/dotfiles/master/bin/dotfiles | bash -s -- --tags comma,seperated,tags
```
